...
def main() -> None:
    ...
    config["train"] = {**config.get("train", {}), "batch_size": 1, "num_workers": 0}
    config["mil"] = {**config.get("mil", {}), "max_instances_per_bag": 8}
    ...
    print(f"bag sizes: {[int(bag.size(0)) for bag in batch['images']]}")
